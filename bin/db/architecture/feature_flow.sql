# Flow
# 1. Game Features - Game Id = BOS199004090 (Around 0.453 seconds)

select event_catcher.Catcher from event_catcher inner join
event_instance on event_instance.idEvent=event_catcher.idEvent
where event_instance.Game_ID = 'BOS199004090'
order by CHAR_LENGTH(event_instance.idEvent), event_instance.idEvent;
...
event_third_base.Third_Base, event_shortstop.Shortstop
	...
	where event_instance.Game_ID = 'BOS199004090' order by batter_in_event.batting_team, CHAR_LENGTH(event_instance.idEvent), event_instance.idEvent;
